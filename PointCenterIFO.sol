...
// File: @unityswap/unity-swap-lib/contracts/math/SafeMath.sol
...
// File: @unityswap/unity-swap-lib/contracts/utils/Address.sol
...
// File: @unityswap/unity-swap-lib/contracts/token/BEP20/SafeBEP20.sol
...
// File: @unityswap/unity-swap-lib/contracts/utils/ReentrancyGuard.sol
...
contract PointCenterIFO is Ownable {
    ...
    constructor(address _unityProfileAddress, uint256 _maxViewLength) public {
    ...
    function getPoints(address _contractAddress) external {
        ...
        bool isUserActive = unityProfile.getUserStatus(senderAddress);
